...
enum RENDERER
{
	RENDERER_FORWARD_CLASSIC = 1,
	RENDERER_FORWARD_CLUSTERED,
	RENDERER_DEFERRED_CLASSIC,
	RENDERER_DEFERRED_CLUSTERED,
};
...
enum RENDER_FLAGS
{
	...
	RENDERFLAG_USE_SHADOW_MAPS = 1 << 1,
	RENDERFLAG_USE_BLOOM = 1 << 2,
};
...
enum DEBUG_DRAW
{
	...
	DEBUG_DRAW_ACTIVE_CAMERA_CLUSTERS = 1 << 10,
};
...
enum EXTENSIONS
{
	...
	EXT_SHADER_DRAW_PARAMETERS = 1 << 6,
};
